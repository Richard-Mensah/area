    ...
    <div className="flex flex-col gap-5">
      ...
      <div className="flex flex-col sm:flex-row gap-3 items-start sm:items-end">
        ...
        <div className="w-full sm:w-52">
          <Select
            label="Risk Level"
            options={[{ value: "all", label: "All Risk Levels" }, ...riskLevels.map((r) => ({ value: r, label: r }))]}
            value={riskFilter}
      ...
      <p className="text-sm text-gray-500">Showing {filtered.length} of {predictions.length} students</p>
