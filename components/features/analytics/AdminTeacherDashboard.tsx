...
export default function AdminTeacherDashboard({ role }: Props) {
    ...
    <div className="flex flex-col gap-6">
      ...
      <div>
        <h2 className="text-xl font-bold text-gray-900">
          {role === "admin" ? "School Overview" : "My Classes Overview"}
        </h2>
        <p className="text-sm text-gray-500 mt-1">
          {role === "admin"
            ? "School-wide attendance and academic health"
            : "Attendance and predictions for your assigned subjects"}
        </p>
      </div>
      ...
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
        <StatsCard
          title={role === "admin" ? "Total Students" : "My Students"}
